...
export default function Home() {
  return (
    <main className="relative isolate flex h-dvh min-h-[770px] flex-col justify-between gap-[clamp(16px,2.5vh,34px)] px-10 pt-[calc(72px+30px)] pb-[104px] overflow-hidden max-[750px]:h-auto max-[750px]:min-h-dvh max-[750px]:justify-start max-[750px]:gap-8 max-[750px]:px-5">
      <div
        aria-hidden
