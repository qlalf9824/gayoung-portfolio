...
export const collectivCareer: Career = {
  ...
  summary:
    "세 번째 옷은 지금도 입고 있습니다. Next.js 웹과 Flutter 하이브리드 앱을 새롭게 만들며 서비스의 기반을 직접 설계하고 있고, 커머스 핵심 기능부터 웹뷰 Bridge, 성능 최적화와 이벤트 계측까지 제품이 운영되는 과정 전반을 다루고 있습니다. 최근에는 AI Agent와 PR 자동화를 만들며 팀 전체가 더 정확하고 효율적으로 개발하는 방법을 고민하고 있습니다.",
